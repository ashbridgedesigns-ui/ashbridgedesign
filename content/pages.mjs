...
<section class="section"><div class="wrap prose">
  ...
  <ul><li><strong>Enquiries:</strong> your name, contact details, property address and project information, used to reply and quote (legitimate interests, or steps before entering a contract).</li><li><strong>Clients:</strong> the information needed to carry out surveys, inspections and design work, and to keep business records (contract and legal obligation).</li><li><strong>Follow-up:</strong> with your consent, occasional messages about relevant services, such as your 2-year warranty inspection. You can opt out at any time.</li>${site.ga4Id ? `<li><strong>Website analytics:</strong> we use Google Analytics to see how the site is used (pages viewed, and whether enquiry or WhatsApp buttons are used) so we can improve it. Analytics cookies are only set if you accept them. See <a href="#cookies">cookies</a> below.</li>` : ''}</ul>
  <h2>Who we share it with</h2>
  <p>Only where needed to deliver your service: councils and building control bodies (for applications), inspectors or survey partners working for us, and our website, email and form-hosting providers${site.ga4Id ? ', and Google, which provides our website analytics' : ''}. We never sell your data.</p>
  ${site.ga4Id ? `<h2 id="cookies">Cookies</h2>
  <p>We ask before setting any analytics cookies. If you accept, Google Analytics sets the <code>_ga</code> and <code>_ga_*</code> cookies, which last up to 2 years, to count visits and see which pages are used. If you reject, Google Analytics runs without cookies and can't recognise you between visits. We don't use advertising cookies.</p>
  <p>Your choice is saved in your browser, so we don't ask on every page. You can change it at any time using <strong>Cookie settings</strong> at the bottom of every page. Rejecting also deletes any analytics cookies already set.</p>` : ''}
