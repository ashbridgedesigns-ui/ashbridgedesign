...
export function snagQuoteTool(heading = 'Instant snagging price') {
  ...
  <div class="stack-sm"><p class="eyebrow">Instant price</p><h2>${heading}</h2><p class="muted">Priced by bedrooms. No VAT to add. Book online with a ${gbp(prices.deposit)} deposit.</p></div>
  <div class="tool-grid">
...
export function pciTool() {
  ...
  <div class="stack-sm"><p class="eyebrow">Inspection window checker</p><h2>When can my home be inspected?</h2><p class="muted">For homes bought from an NHQB-registered developer.</p></div>
...
export const engineerBand = `<section class="section section-dark"><div class="wrap engineer">
  ...
  <div class="stack">
    ...
    <h2>Most drawing firms use drafters. Most snagging firms use ex-tradespeople. Ashbridge is run by a civil engineer.</h2>
    <ul class="ticks">
      <li><strong>Drawings that get through building control first time:</strong> beams, foundations and drainage are considered from day one, not bolted on later.</li>
