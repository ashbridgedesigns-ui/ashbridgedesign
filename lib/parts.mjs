...
export function designQuoteTool() {
  ...
  <fieldset class="field"><legend>What do you need?</legend><div class="choice">
    ...
    <label><input type="radio" name="stage" value="s2"> Building Regulations drawings</label>
    <label><input type="radio" name="stage" value="both" checked> Both stages</label>
    <label><input type="radio" name="stage" value="complete"> Complete, with structural calculations</label>
  </div></fieldset>
  <div class="result" aria-live="polite"></div>
</div>`;
}
...
export function designPriceTable() {
  ...
  <thead><tr><th>Project</th><th class="num">Stage 1<br>Planning</th><th class="num">Stage 2<br>Building Regulations</th><th class="num">Both stages</th><th class="num">Complete<br>+ structural calculations</th></tr></thead>
  <tbody>${rows}
